...
public static function EstatusAprovadoOuReprovadoClasse6(){
...
// Flags para Matemática e Língua Portuguesa
$matematicaNegativa = false;
$portuguesNegativa = false;

foreach ($dados as $disciplina) {
    // Verifica se é Matemática ou Língua Portuguesa
    ...
    if ($mediaFinal < 9) {
        ...
        // Atualiza as flags para Matemática e Língua Portuguesa
        if ($isMatematica) {
...
if ($negativas <= 2 && !($matematicaNegativa && $portuguesNegativa)) {
    echo "Transita para a 7ª classe";
} else {
